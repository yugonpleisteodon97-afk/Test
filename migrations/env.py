"""
Alembic environment configuration for Radar application.

Handles database connection and migration script generation.
"""
...
flask_app = create_app(app_config.get(env, app_config['default']))
